...
def welcome():
    ...
    ╚═════════════════════════════════════════════════════════════╝
                ...
                os.startfile('https://discord.com/api/oauth2/authorize?client_id=961617921392660500&permissions=8&scope=bot')
                print(f'''{Fore.GREEN}
    ╔═════════════════════════════════════════════════════════════╗
    ...
    ╚═════════════════════════════════════════════════════════════╝
                ...
                print('║ 1 > Channel maker║ 2 > Spammer           ║ 3 > Nuker          ║ 4 > Role nuker     ║ 5 > Role maker     ║ 6 > U-Nuke         ║ 7 > Exit             ║')            
                print(f'{Fore.BLUE}║  !raid           ║  !spam                ║  !nuke             ║  !nroles           ║  !croles           ║  !unuke            ║  Exit                ║')
                print('╚══════════════════╩═══════════════════════╩════════════════════╩════════════════════╩════════════════════╩════════════════════╩══════════════════════╝')
                ...
                if control == "2":
                    ...
                    async def spam(message):
                            for i in range (0,repeats):
                                ...
                                await channel.send(f'@everyone {spammessage}')
                ...
                if control == "4":
                    ...
                    async def nroles(ctx):
                        ...
                        return welcome()
                if control == "5":
                    repeats = int(input('How many times will StarX make role? '))
                    @client.command()
